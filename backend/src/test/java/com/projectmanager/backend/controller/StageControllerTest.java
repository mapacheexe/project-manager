...
class StageControllerTest {
    ...
    void givenValidRequest_whenCreate_thenReturnsOk() {
        ...
        ResponseEntity<StageDTO> response = controller.create(10L, 1L, request);
    ...
    void givenValidRequest_whenUpdate_thenReturnsOk() {
        ...
        ResponseEntity<StageDTO> response = controller.update(100L, 1L, request);
    ...
    void givenValidRequest_whenReorder_thenReturnsOk() {
        ...
        ResponseEntity<List<StageDTO>> response = controller.reorder(10L, 1L, request);
